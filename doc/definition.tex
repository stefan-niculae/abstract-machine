...
\langle v:=E  \bm{c},  \bm{s},  \bm{m} \rangle    &\rightarrow   \langle E :=  \bm{c}, v  \bm{s},  \bm{m} \rangle \\
\langle :=  \bm{c}, n v  \bm{s},  \bm{m} \rangle    &\rightarrow   \langle  \bm{c},  \bm{s},  \bm{m}[v=n] \rangle \\
\end{align*}
Branching $(if)$:
\begin{align*}
