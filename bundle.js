...
evaluate = function(program) {
  var current, exitCalled, limitReached, states;
  current = {
    c: [program],
    s: [],
    m: {}
  ...
  while (current.c.length > 0) {
    ...
    if (exitCalled) {
      current.terminationCause = 'exit called';
    }
    if (limitReached) {
      current.terminationCause = 'execution limit reached';
    }
    states.push(current);
    if (exitCalled || limitReached) {
      break;
    }
  }
  return states;
...
nearley = __webpack_require__(9);

grammar = __webpack_require__(6);
...
// module
exports.push([module.i, "body {\n  max-width: 550px;\n  margin: auto;\n  font-family: \"Open Sans\", sans-serif;\n  font-size: 15px;\n  background-color: #fdfdfd; }\n\nheader {\n  margin-top: 1.25em;\n  margin-bottom: .2em;\n  font-size: 1.5em; }\n  header a {\n    font-size: .65em; }\n    header a::before {\n      content: '('; }\n    header a::after {\n      content: ')'; }\n\na {\n  color: #191919; }\n\n#program-input,\n#parse-output,\n#evaluation-output {\n  padding: 5px 10px;\n  min-height: 200px;\n  border-radius: 3px;\n  border: .5px solid #c8c8c8;\n  box-shadow: 0 0 5px 2px rgba(0, 0, 0, 0.1); }\n\n#program-input {\n  width: 100%;\n  font-family: Consolas, monospace;\n  font-size: 1em;\n  color: #191919; }\n\n#examples a {\n  margin-right: .5em; }\n\n.info,\n.error {\n  text-align: center;\n  line-height: 200px; }\n\n.info {\n  color: grey; }\n\n.error {\n  color: red; }\n\n#parse-output,\n#evaluation-output,\n#current-state {\n  background-color: white; }\n\n#evaluation-output {\n  height: 220px;\n  overflow-y: auto; }\n\n#current-state {\n  width: 50px;\n  font-size: 1em;\n  text-align: center; }\n\n#evaluation-control {\n  margin-top: 15px;\n  text-align: center; }\n  #evaluation-control #state-numbers {\n    margin-left: 2em;\n    margin-right: 2em; }\n  #evaluation-control a {\n    margin-left: .5em;\n    margin-right: .5em; }\n\nfooter {\n  margin-top: 100px;\n  margin-bottom: 25px;\n  font-size: small;\n  text-align: center; }\n  footer a {\n    color: grey; }\n", ""]);
...
Configuration = (function() {
  function Configuration(arg) {
    ...
    this.c = arg.c, this.s = arg.s, this.m = arg.m, terminationCause = arg.terminationCause;
...
showState = function(idx) {
  var currIdx, lastIdx, state;
  lastIdx = this.states.length - 1;
  if (idx === 'first') {
    idx = 0;
  }
  if (idx === 'last') {
  ...
  return evalOutput.removeClass('info error').html(jsonViewer(new Configuration(state)));
};
...
$('#first-state').click(function(e) {
  e.preventDefault();
  return showState('first');
});
